...
void loop() {
  // Wait until it receives the signal from MATLAB to begin data capture
  
  // Output data to MATLAB in the following format per line: AQI, VOCs, CO2
  if (myENS.checkDataStatus()) {
    ...
    // Easy format for MATLAB to read in: AQI, VOCs, CO2
